...
# from eaglevl.train.liger_loss_weight_ops import LigerFusedLinearCrossEntropyLoss  # disabled for V100
...
class LocateAnythingForConditionalGeneration(LocateAnythingPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        # V100 fallback: use regular PyTorch cross entropy instead of Liger fused loss.
        # This is slower and uses more memory, but avoids Triton/Liger kernel mismatch on V100.
        shift_logits = F.linear(shift_hidden_states, lm_head_weight)
