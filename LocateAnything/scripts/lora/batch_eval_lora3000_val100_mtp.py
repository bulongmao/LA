...
INPUT_ROOT = Path("/data/ljy/locate_anything_project/eval_images/val_quick100")
OUTPUT_ROOT = Path("/data/ljy/locate_anything_project/outputs_eval/lora3000_val100")

MODEL_PATH = "/data/ljy/locate_anything_project/lora_foutputs/food_plate_lora_v100_4gpu_3000step/checkpoint-3000_infer"
